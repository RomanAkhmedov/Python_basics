...
class Road:
    ...
    def asphalt_weight(self, one_meter_asphalt, thickness_road):
        return self._length * self._width * one_meter_asphalt * thickness_road


path = Road(140, 15)
print(f'Масса асфальта, необходимая для покрытия дорожного полотна: {path.asphalt_weight(10, 15)} тонн')
